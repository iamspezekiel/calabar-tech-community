  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert prose-lg max-w-none text-muted-foreground space-y-4">
        ...
        <p>
          Calabar Tech Community ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
        </p>
        ...
        <ul>
          <li>
            <strong>Personal Data:</strong> Personally identifiable information, such as your name, shipping address, email address, and telephone number, that you voluntarily give to us when you register for an event or contact us.
          </li>
          <li>
        ...
        <ul>
          <li>Administer events, promotions, and contests.</li>
        ...
        <h2 className="text-foreground">3. Disclosure of Your Information</h2>
        <p>
        ...
        <h2 className="text-foreground">4. Security of Your Information</h2>
        <p>
